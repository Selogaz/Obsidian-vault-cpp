...
updated: 2026-06-11T00:53:07+03:00
total_hours: 0
---
...
- **[[мета-заметка|Мета-заметка]]** = "это большая тема, вокруг которой я буду собирать знания"
- **[[конвейер знаний от источника до иерархии|Иерархия]]** = "это конкретная группа заметок, которая относится к теме"
