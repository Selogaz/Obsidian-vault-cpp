...
updated: 2026-06-22T01:04:20+03:00
related:
---
...
- **Декларативная отрисовка**: vue расширяет стандартный html синтаксисом шаблонов, позволяет описывать декларативно финальный html *на основе состояния JavaScript*
