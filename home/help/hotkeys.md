...
- alt + [m]etadata – keyboard orientated [metadata menu](obsidian://show-plugin?id=metadata-menu)
...
- alt + [h]eadings – heading search
	- alt + shift + h – [add status](https://habr.com/en/articles/789248/#5) to the heading
- alt + [b]acklinks
...
- alt + q – [create a task](https://youtu.be/4wB-Ph5XYV0?t=22670) (in context)
	- alt + shit + q – addition for tasks
- alt + [a]lias – add alias to the current note
	- alt + shift + a – [add alias](obsidian://show-plugin?id=note-aliases) of the link under cursor in the target note frontmatter
...
- F9 – [open a note](https://youtu.be/4wB-Ph5XYV0?t=28322) for review
	- F10 – easy note
	- F11 – hard note
...
- alt + re[f]actor – extract selection to new note ([first line as file name](https://youtu.be/4wB-Ph5XYV0?t=8696))
	- alt + shift + [f]ootnote – add footnote
- alt + wi[k]i-link – add wikilink
	- alt + shift + k – add markdown link
- alt + [c]allout – [inline callouts](obsidian://show-plugin?id=obsidian-list-callouts)
