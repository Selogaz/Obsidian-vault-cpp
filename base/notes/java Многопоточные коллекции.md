...
Например, подойдет для реализации [[java паттерны gof#java паттерн наблюдатель Observer|паттерн наблюдатель]] или [[java паттерн наблюдатель|паттерн наблюдатель]]
