...
updated: 2026-06-21T12:15:24+03:00
---

# Повышение скорости обновлений в Manjaro Linux

Медленная загрузка [[обновление Manjaro|обновлений]] через `sudo pacman -Syu` обычно связана с плохими зеркалами (mirrors), а не с качеством интернет-соединения.
