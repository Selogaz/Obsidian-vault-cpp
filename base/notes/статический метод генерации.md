...
```
- [-] #task/inbox #category/java - Как связаны с этой заметкой [[java Factory method|Factory method]], [[java builder|builder]], и [[java паттерны gof]]? ❌ 2026-07-04
- [-] #task/inbox #category/java Какие фабрики называют нестатическими? ❌ 2026-07-04
