...
Плюс у Spring огромное количество модулей, которые упрощают разработку: [[base/notes/Spring Boot]], Spring [[java MVC|MVC]], Spring Data, [[java Spring Security|Spring Security]] и тд
