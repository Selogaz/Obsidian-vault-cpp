...
[[base/notes/Spring Boot]] по умолчанию использует CGLIB. Для использования прокси JDK необходимо выставить настройку `spring.aop.proxy-target-class B false`
