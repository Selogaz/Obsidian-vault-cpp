Вектор - динамический массив на стероидах. Сам выделяет память, сам удаляет, имеет множество встроенных методов. Имеет быстрый доступ к элементам(быстро итерируется по ним)
