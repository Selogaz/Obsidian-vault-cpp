...
- Тип проекта и команда
	- Что за продукт? Состав команды?
		- Проект - веб-сервис для управления блогом компании: создание, редактирование и публикация статей, работа с комментариями и пользователями. Команда - 1 техлид фулстек, 2 бэкенда, 2 фронтендера, 2 тестировщика(QA), Аналитик, который описывает ТЗ задач. Работали по двухнедельным спринтам.
